...
public class CategoryController {
    ...
    public ResponseEntity<Category> updateCategory(@PathVariable long id, @RequestBody Category categoryDetails) {
        ...
        updateCategory.setAge(categoryDetails.getAge());
        updateCategory.setAddress(categoryDetails.getAddress());
        updateCategory.setContactno(categoryDetails.getContactno());
        updateCategory.setEmailadd(categoryDetails.getEmailadd());
       updateCategory.setMedicalcondition(categoryDetails.getMedicalcondition());
        updateCategory.setPrescription(categoryDetails.getPrescription());
